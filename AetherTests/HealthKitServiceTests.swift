...
final class HealthKitServiceTests: XCTestCase {
    ...
    func testRequestAuthorizationFailure() async throws {
        try XCTSkipIf(ProcessInfo.processInfo.environment["SIMULATOR_DEVICE_NAME"] != nil || ProcessInfo.processInfo.environment["CI"] != nil, "跳过：模拟器/CI 环境无法处理 HealthKit 权限弹窗")
        let service = HealthKitService()
        do {
