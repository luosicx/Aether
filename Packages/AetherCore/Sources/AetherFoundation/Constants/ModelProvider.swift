...
public enum ModelProvider: String, CaseIterable, Sendable {
    ...
    public var chatEndpoint: String { "/chat/completions" }

    /// embeddings 接口路径（两家都用 OpenAI 兼容格式，路径一致）
    public var embeddingEndpoint: String { "/embeddings" }
    ...
    public var defaultReasonerModel: String {
        switch self {
    ...
    public var fallback: ModelProvider {
        switch self {
