...
struct AIBuilderApp: App {
    ...
    nonisolated static func scheduleDailyRefresh() {
        let request = BGAppRefreshTaskRequest(identifier: "com.aibuilder.daily-refresh")
    ...
    nonisolated static func scheduleTelemetryUpload() {
        let request = BGAppRefreshTaskRequest(identifier: "com.aibuilder.telemetry-upload")
    ...
    nonisolated static func scheduleHealthInsight() {
        let request = BGAppRefreshTaskRequest(identifier: "com.aibuilder.health-insight")
        // 计算下次 09:00 的时间
